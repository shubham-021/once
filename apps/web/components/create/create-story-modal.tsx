  ...
  const renderStep = () => {
    if (isProtagonistMode) {
      switch (currentStep) {
        case 0:
          return (
            <StepBasics form={form} updateForm={updateForm} errors={errors} />
          );
        case 1:
          return (
            <StepStory form={form} updateForm={updateForm} errors={errors} />
          );
        case 2:
          return (
            <StepWorld form={form} updateForm={updateForm} errors={errors} />
          );
        case 3:
          return (
            <StepCast form={form} updateForm={updateForm} errors={errors} />
          );
      }
    } else {
      switch (currentStep) {
