                ...
                <div className="grid grid-cols-2 gap-3">
                    <button
                        ...
                        className={cn(
                            ...
                            isProtagonistMode ? "border-accent bg-accent/10" : "border-line hover:border-foreground/50"
                        )}
                    >
                        <User className={cn("size-4", isProtagonistMode ? "text-accent" : "text-muted")} />
                    ...
                    >
                        <Globe className={cn("size-4", !isProtagonistMode ? "text-accent" : "text-muted")} />
                ...
                <>
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={(e) => updateForm("protagonist", { ...form.protagonist!, name: e.target.value })}
                    ...
                    <div className="space-y-2">
                        <label className="text-sm text-muted">Traits ({form.protagonist?.traits?.length || 0}/5)</label>
                        <div className="flex flex-wrap gap-2">
